...
| [⚠️ Section 12](./section-10) | **Design Considerations** | 32 open items (DC-1 to DC-32) with implementation options and platform-specific guidance. The architectural principles from each DC are absorbed into Key Principles (P29–P62). This section retains the detailed implementation options, platform-specific caveats, and options to evaluate for each item. |
